...
if not firebase_admin._apps:
    try:
        ...
        if firebase_creds:
            ...
            print(f"DEBUG: Looking for Firebase credentials at {credentials_path}")
...
# ------------------------------
# Include Routers (Must be AFTER Firebase Init)
# ------------------------------
from routers import auth, resume, roadmap, user, joblisting, assessment, interview, leaderboard
